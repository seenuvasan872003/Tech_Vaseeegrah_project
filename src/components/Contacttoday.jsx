...
return (
    <>
        <div className='text-center flex flex-col items-center justify-center px-4 lg:px-0 pt-15 pb-28 mb-5'>
            <div>
            ...
            <div className='w-full md:w-96'>
                <form className='flex flex-col md:flex-row gap-4' onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className='w-full md:w-fit bg-[#1c58b9] hover:bg-[#72da83] text-white hover:text-black text-center font-bold shadow-[5px_5px_0px_0px_rgba(0,0,0)] py-3 px-3 rounded'>Get Started</button>
                </form>
            </div>
        </div>
    </>
